...
| **Banner** | `bannerCard` | Large centered content with color and emoji support |
...
├── modals/ImagePickerModal.ts     # Native image file picker integration
└── modals/LinkPickerModal.ts      # Internal link/file suggest modal
